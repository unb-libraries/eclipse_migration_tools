    ...
    for cur_tree_file in tree_files:
        ...
        if len(raw_a_tag_values) > 0 :
            ...
            for cur_raw_a_tag_value in raw_a_tag_values :
                ...
                if 'href' in cur_raw_a_tag_value and not '<?' in cur_raw_a_tag_value and not ' $' in cur_raw_a_tag_value and not cur_raw_a_tag_value.count('\\') > 3 and not 'file://' 
in cur_raw_a_tag_value:
